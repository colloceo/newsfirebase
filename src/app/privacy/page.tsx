    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto prose lg:prose-xl">
          ...
          <h2><FileText className="inline-block mr-2 h-6 w-6 text-primary"/>Information Collection and Use</h2>
          <p>
          ...
          <h2><FileText className="inline-block mr-2 h-6 w-6 text-primary"/>Log Data</h2>
          <p>
          ...
          <h2><FileText className="inline-block mr-2 h-6 w-6 text-primary"/>Cookies</h2>
          <p>
          ...
          <h2><FileText className="inline-block mr-2 h-6 w-6 text-primary"/>Changes to This Privacy Policy</h2>
          <p>
